...
from src.backoffice.definitions import DEFAULT_EMAIL_TEMPLATE
from src.gfvgbo.secrets import SMTP_SERVER, SMTP_USER, SMTP_PASSWORD, EMAIL_SENDER

from src.telegram_bot.log_utils import email_logger as logger
